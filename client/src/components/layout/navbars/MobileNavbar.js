...
const MobileNavbar = () => {
  ...
  return (
    <>
      <Navbar
        className={`${
          isOpen ? "h-100 slider-container" : "squad-background-color"
        } mobile-navbar position-absolute w-100 d-flex flex-column align-items-start`}
        expand="lg"
      >
            ...
            >
              ...
              >
                ...
                <i
                  className={
                    !isOpen
                      ? "fas fa-heart text-dark heart"
                      : "fas fa-heart squad-color heart"
                  }
                ></i>
                D
              </h2>

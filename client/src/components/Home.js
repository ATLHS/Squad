...
const live_tutors = [
    {id: 1, name: "Catherine", title: "Yoga", price: "40", statut: "Disponible", bio: "Professeur de yoga diplômée Hatha Yoga, tout âge et tout niveau", img: "https://www.superprof.fr/images/annonces/professeur-home-professeur-yoga-diplomee-hatha-yoga-cours-individuel-equipe-skype-zoom-actuellement-age-niveau.jpg"},
    {id: 2, name: "Gaston", title: "Yoga", price: "60", statut: "Disponible", bio: "Cours de Yoga, renforcement musculaire et detente. Prof certifié Yoga Buenos Aires. En français ou espagnol.", img: "https://www.superprof.fr/images/annonces/professeur-home-cours-yoga-particulier-groupe-renforcement-musculaire-detente-prof-certifie-yoga-buenos-aires-francais-espagnol.jpg"},
    {id: 3, name: "Laura", title: "Cuisine Italienne", price: "30", statut: "Disponible", bio: "Découvrez avec moi la VRAIE CUISINE ITALIENNE. Les meilleures recettes de famille, les plats simples mais d'effet à base de produits frais, et toutes les astuces pour épater votre famille et vos amis.", img: "https://www.superprof.fr/images/annonces/professeur-home-decouvrez-vraie-cuisine-italienne-meilleures-recettes-famille-plats-simples-effet-base-produits.jpg"},
    {id: 4, name: "Sayar Yang", title: "Tai Chi", price: "80", statut: "Disponible", bio: "(ancien moine bouddhiste) kung fu,tai chi, self-défense, boxing, méditation, chi gong, massage,que je vous enseigne les techniques originelles transmises par mes Maîtres", img: "https://www.superprof.fr/images/annonces/professeur-home-ancien-moine-bouddhiste-kung-tai-chi-self-defense-boxing-meditation-chi-gong-massage-enseigne-techniques.jpg"},
    {id: 5, name: "Masha", title: "Peinture", price: "30", statut: "disponible", bio: "Diplômée des Beaux Arts de Moscou donne cours particuliers peinture et dessin", img: "https://www.superprof.fr/images/annonces/professeur-home-diplomee-beaux-arts-moscou-donne-cours-particuliers-peinture-dessin.jpg"},
    {id: 6, name: "Louis", title: "Musculation", price: "60", statut: "Disponible", bio: "Coach Fitness sur Paris donnant des cours de Renforcement Musculaire / Cardio / Pilates / Yoga / Stretching pour tous types de niveaux.", img: "https://www.superprof.fr/images/annonces/professeur-home-coach-fitness-paris-donnant-cours-salle-sport-privee-domicile.jpg"},
    {id: 7, name: "Nicolas", title: "Fitness", price: "50", statut: "Disponible", bio: "Coaching individualisé fitness/remise en forme pour tous niveaux.", img: "https://www.superprof.fr/images/annonces/professeur-home-coaching-individualise-fitness-remise-forme-niveaux-paris-banlieue-proche.jpg"},
    {id: 8, name: "Sergey", title: "Peinture", price: "40", statut: "Disponible", bio: "Intervenant et Jury aux Gobelins, Réalisateur, Character designer : Cours de dessin, Storyboard, animation 2D, 3D MAYA, TVPAINT, Photoshop, Sculpture, préparation aux écoles d'Art et d'Animation", img: "https://www.superprof.fr/images/annonces/professeur-home-intervenant-jury-gobelins-realisateur-character-designer-cours-dessin-storyboard-animation-maya-tvpaint.jpg"},
    {id: 9, name: "Eden", title: "Boxe", price: "50", statut: "Disponible", bio: "Coach Sportif Personnel - SEANCE DE COACHING SPORTIF Cours particulier à domicile ou en extérieur - Paris / Banlieue EDEN COACH à votre disposition", img: "https://www.superprof.fr/images/annonces/professeur-home-coach-sportif-personnel-seance-coaching-sportif-cours-particulier-domicile-exterieur-paris-banlieue-eden-coach.jpg"}
]
    ...
    return (
        <>
            ...
            <Row as="section" className="h-100 m-0 flex-wrap">
                ...
                <Col xs={12} md={6} className="d-flex justify-content-center align-items-center squad-section-3 bg-white">
                    <SquadCardExemple />
                </Col>
